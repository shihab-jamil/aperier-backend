        ...
        <AccordionComponent>
          <AccordionItemComponent heading_id="headingOne" collapse_id="collapseOne" title="Ethical Oversight">
            ...
            <p>We focus on the <a href="https://publicationethics.org/" target="_blank">СОРE</a> definition, of Ethical
              ...
              journals works under the issue of observing the ethical principles.</p>
            <p>The journals will be bound to consider the appeals from the Ethics and Oversight Committee for
              professional and scientific activity concerning the non-observance of the ethical principles by our
              authors. We are also ready to consider other appeals in case they are not anonymous and substantiated.</p>
          ...
          <AccordionItemComponent heading_id="headingTwo" collapse_id="collapseTwo" title="Authorship">
            ...
            <ul>
              <li>Substantial contributions to the conception or design of the work; or the acquisition, analysis, or
                interpretation of data for the work; AND</li>
              ...
              <li>Agreement to be accountable for all aspects of the work in ensuring that questions related to the
                accuracy or integrity of any part of the work are appropriately investigated and resolved.</li>
            </ul>
            <p>Those who contributed to the work but do not qualify for authorship should be listed in the
              acknowledgments. More detailed guidance on authorship is given by ICMJE.</p>
            <p>Any change to the author list during the editorial process or after publication should be approved by all
              authors, including any who have been removed. We reserve the right to request evidence of authorship, and
              changes to authorship after acceptance will be made at the discretion of Aperier.</p>
            <strong>Changes to Authorship</strong>
            <p>Authors are expected to carefully consider authorship before manuscript submission. Any change to the
            ...
            <p>If a manuscript is submitted with a deceased author included in the authorship, or if an author passes
              ...
              the deceased author was a corresponding author, the authorship group should nominate a co-author for this
              role. The corresponding author should confirm the contribution of the deceased author and any potential
              conflicts of interest. Upon publication, a note will be added under the author list.</p>
            ...
            <p>When submitting an article, the corresponding author should define the role of each author and specify
              ...
              not its authors. All submitted manuscripts should include an author contributorship statement that
              specifies the work of each author. For research articles with several authors, a short paragraph
              specifying their individual contributions must be provided.</p>
            <p>The corresponding author should act as a point of contact between the editor and the other authors, keep
              co-authors informed, and involve them in major decisions about the publication.</p>
            <p>The following statements should be used: Conceptualization, X.X. and Y.Y.; methodology, X.X.; software,
              X.X.; validation, X.X., Y.Y. and Z.Z.; formal analysis, X.X.; investigation, X.X.; resources, X.X.; data
              curation, X.X.; writing&mdash;original draft preparation, X.X.; writing&mdash;review and editing, X.X.;
              visualization, X.X.; supervision, X.X.; project administration, X.X.; funding acquisition, Y.Y. All
              authors have read and agreed to the published version of the manuscript.</p>
            <p>We kindly hope that when you send an article to the editors of our journals, all those who have really
              contributed to its preparation will be taken into account and there will be no persons unrelated to its
              scientific content. We also hope that there will be no persons among the article writers who would like to
              claim authorship using authority over the true authors, who financed the results generation or sponsored
              АРС payment, who promised to include the true authors in their future article or made this earlier and
              claim now to compensation. If the results presented in the article were received with the someone's
              financial support, then the authors should disclose funding sources directly by pointing them at the end
              of the article.</p>
          </AccordionItemComponent>
          ...
          <AccordionItemComponent heading_id="headingThree" collapse_id="collapseThree"
            ...
            <p>Aperier publishes all its journals in full open access, meaning unlimited use and reuse of articles, in
              ...
              publishing, so there are no publication charges for authors whose work is accepted for publication in
          ...
          <AccordionItemComponent heading_id="headingFour" collapse_id="collapseFour" title="Copyright and Permissions">
            <p>Author&apos;s rights to the contents of the article are determined depending on whether article is
              ...
              unlimited access to the full-text of all articles published in MDPI journals;<br>everyone is free to
              re-use the published material if proper accreditation/citation of the original publication is
              given;<br>Open access articles are committed to be published under Creative Commons Attribution (CC BY)
              4.0. This license allows others to distribute, edit, correct and build upon your work, even commercially,
              as long as they indicate your authorship. Detailed information at Creative Commons site:
              https://creativecommons.org/licenses/by/4.0/<br><br><strong>Permissions</strong><br>No special permission
              is required to reuse all or part of article published by Aperier, including figures and tables. For
              articles published under an open access Creative Common CC BY license, any part of the article may be
              reused without permission provided that the original article is clearly cited. Reuse of an article does
          ...
          <AccordionItemComponent heading_id="headingSix" collapse_id="collapseSix" title="Citation Policies">
            <p>Authors should ensure that where material is taken from other sources (including their own published
              writing), the source is clearly cited and that where appropriate permission is obtained.<br>Authors should
              not engage in excessive self-citation of their own work.<br>Authors should not copy references from other
              publications if they have not read the cited work.<br>Authors should not preferentially cite their own or
              their friends&rsquo;, peers&rsquo;, or institution&rsquo;s publications.<br>Authors should not cite
              advertisements or advertorial material.<br>In accordance with COPE guidelines, we expect that
              &ldquo;original wording taken directly from publications by other researchers should appear in quotation
              marks with the appropriate citations&rdquo;. This condition also applies to an author&rsquo;s own work.
              COPE have produced a discussion document on citation manipulation with recommendations for best practice.
            </p>
          </AccordionItemComponent>
        </AccordionComponent>
      </div>
