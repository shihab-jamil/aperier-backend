                    ...
                    <div class="card col-12 ">
                        <div class="card-body d-flex flex-column p-5" style="gap:30px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input type="text" class="p-1" placeholder="From-To eg. 1-100" v-model="formData.page" />
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <textarea name="" id="" cols="30" rows="2" class="w-100 p-3"
                                        placeholder="Title" v-model="formData.title"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <textarea name="" id="" cols="30" rows="13" class="w-100 p-3"
                                        placeholder="Abstract" v-model="formData.abstract"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <textarea name="" id="" cols="30" rows="2" class="w-100 p-3"
                                        placeholder="Keywords; seperate the keywords with semicolon (;)" v-model="formData.keywords"></textarea>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-4 offset-4 d-flex flex-column align-items-center" style="gap:15px">
                                  ...
                                  <button  @click="openFile()"  class="btn-register">Select File</button>
                                    ...
                                    <span>Please download and fill the
                                        <span class="text-info">Manuscript Template</span>
                                    </span>
                                </div>
                            </div>
                            <div class="row">
