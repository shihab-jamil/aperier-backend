              ...
              <div class="card col-12 ">
                <div class="card-body d-flex flex-column p-5" style="gap:30px">
                  ...
                  <div class="row">
                    ...
                    <div class="col-10">
                        <textarea name="" id="" cols="30" rows="2" class="w-100 p-3" placeholder="Title" v-model="formData.title" required></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-2">Abstract:<span class="text-danger">*</span></div>
                    <div class="col-10">
                        <textarea name="" id="" cols="30" rows="13" class="w-100 p-3" placeholder="Abstract" v-model="formData.abstract" required></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-2">Keywords:<span class="text-danger">*</span></div>
                    <div class="col-10">
                        <textarea name="" id="" cols="30" rows="2" class="w-100 p-3" required placeholder="Keywords; seperate the keywords with semicolon (;)" v-model="formData.keywords"></textarea>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row ">
                    <div class="col-6 d-flex flex-column align-items-center" style="gap:15px">
                      ...
                      <span>Please download and fill the<span class="text-info" style="cursor: pointer"> Manuscript Template</span></span>
                    </div>
                    <div class="col-6 d-flex flex-column align-items-center" style="gap:15px">
                      <span>ATTACH AUTHORSHIP CHANGE <span class="text-info" v-if="formData.author_file_temp">: {{ this.$refs.file2.files[0].name }}</span></span>
                      <input class="form-control" hidden  @change="handleFileUploadAuthor()" type="file" ref="file2" name="file2" id="file2" />
                      <button class="btn-register" @click="openFile2()" type="button"  >Select File</button>
                      <span>Max size is 5 MB</span>
                      <span>Please download and fill the<span class="text-info" style="cursor: pointer"> Authorship Change FORM</span></span>
                    </div>
                  </div>
                  <div class="row">
